...
# Installl tindetheus
RUN git clone https://github.com/cjekel/tindetheus.git && cd tindetheus && git submodule update --init --recursive && python3 -m pip install --upgrade pip && python3 -m pip install --upgrade -r requirements.txt
